...
<html>
	...
	<body>
		...
		<table width="90%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<html:form action="viewYdByKhmc.do?yzr=yzr" >
			...
			<tr>
				<html:form method="post" action="viewYdByFjno.do?yzr=yzr" >
			...
			<logic:present name="yd" scope="request">
				<logic:iterate id="yd" name="yd" scope="request">
					...
					<tr>
						...
						<td width="10%">
							<a href="ydZhuangRz.do?ydid=${yd.ydid }">转入住</a>
						</td>
					</tr>
				</logic:iterate>
			</logic:present>
			...
			<tr>
				...
				<c:choose>
					<c:when test="${pagination.startPage>0}">
						<td width="49">
							<div align="center">
								<a href="/hotelh/fenYeYzr.do?page=0"> 首页 </a>
							</div>
						</td>

						<td width="49">
							<div align="center">
								<a href="/hotelh/fenYeYzr.do?page=${pagination.startPage-1}">
									上一页 </a>
							</div>
						</td>
					</c:when>
				...
				<c:choose>
					<c:when test="${pagination.startPage<pagination.pageNum-1}">
						...
						<td width="49">
							<div align="center">
								<a href="/hotelh/fenYeYzr.do?page=${pagination.pageNum-1}">
									尾页 </a>
							</div>
						</td>
					</c:when>
				...
				<td>
					<form name="formzd" action="/hotelh/fenYeYzr.do"
