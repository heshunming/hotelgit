			...
			<DIV
				...
				<P style="margin: 0px 35px 20px 45px;">
					...
					<SPAN style="float: right;">
						...
						<input name="Submit" type="submit" value="登录" style="background: rgb(0, 142, 173); padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;">
					</SPAN>
				</P>
			</DIV>
		</DIV>
